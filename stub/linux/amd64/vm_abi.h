...
/* 模拟栈位于宿主 RSP 之下 (VM_FRAME_SIZE + VM_FRAME_SKEW_EXTRA + VM_MARGIN) 处。
 * 注意：Go 程序的 goroutine 栈初始只有 8KB，而这个总深度约 12.7KB —— 在 Linux 上会直接
...
#define VM_MARGIN       0x1000 /* 4KB：总深度要装进 Go 的 8KB goroutine 栈 */
