...
#define VM_MARGIN       0x4000 /* 16KB：给"VM 里发起的原生调用"留够宿主栈（原来 3KB 会被 Cython/numpy 压穿到客户机栈上） */ /* 3KB：CI 里 Go 的 goroutine 栈只有 4KB（日志 stack=[0xc000078000,0xc000079000]），总深度必须 < 4KB */
